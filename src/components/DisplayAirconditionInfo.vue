<template>
  <v-card class="mx-auto elevation-8" max-width="32rem" height="40rem" align="center" outlined>
    <v-card-title primary-title pt-12 style="height:3rem;"></v-card-title>
      <v-list-item>
        <v-list-item-content>
      ...
      <v-list-item>
        ...
        <v-list-item-content>
          <v-list-item-title class="headline">{{displayData.workMode}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-list-item>
        <v-list-item-content>
        ...
        <v-list-item-content>
          <v-list-item-title class="headline">{{displayData.windSpeed}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-list-item>
        <v-list-item-content>
        ...
        <v-list-item-content>
          <v-list-item-title class="headline">{{displayData.state}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-list-item>
        <v-list-item-content>
        ...
        <v-list-item-content>
          <v-list-item-title class="headline">{{displayData.costs}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
    <!-- </v-card-text> -->
  </v-card>
